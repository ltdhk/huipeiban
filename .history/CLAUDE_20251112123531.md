...
1. MiniApp使用微信小程序开发框架，使用TDsign
2. **定义 Backend 和 MiniApp 的技术栈**
3. **初始化依赖管理**（package.json、requirements.txt、go.mod 等）
4. **配置开发环境**
5. **在每个组件目录中创建 README 文件**
6. **初始化版本控制**（git 仓库）
7. **定义数据库架构**和数据模型
8. **记录 API 端点**和通信模式
...
### 日志格式
```
[2025-11-11 12:00:00] [INFO] [module.function] - 用户登录成功 user_id=123
```
